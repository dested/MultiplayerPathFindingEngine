...
namespace Pather.Servers.GameSegmentCluster
{
    public class GameSegmentCluster
    {
        ...
        private void CreateGameSegment(CreateGameSegment_GameWorld_GameSegmentCluster_PubSub_ReqRes_Message createGameSegment)
        {
            ...
            {
                GameSegmentClusterPubSub.PublishToGameWorld(new CreateGameSegment_Response_GameSegmentCluster_GameWorld_PubSub_Message()
                {
