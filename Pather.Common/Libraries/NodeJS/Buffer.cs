...
namespace Pather.Common.Libraries.NodeJS
{
    ...
    public class Buffer
    {
        ...
        public int Write(string data, int offset)
        {
            return 0;
        }

        public int Write(string data, int offset, int length)
        {
            return 0;
        }

        public int Write(string data, int offset, int length, Encoding encoding)
        {
            return 0;
        }
        ...
        public byte ReadUInt8(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public ushort ReadUInt16LE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public ushort ReadUInt16BE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public uint ReadUInt32LE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public uint ReadUInt32BE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public sbyte ReadInt8(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public short ReadInt16LE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public short ReadInt16BE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public int ReadInt32LE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public int ReadInt32BE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public float ReadFloatLE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public float ReadFloatBE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public double ReadDoubleLE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public double ReadDoubleBE(int offset, bool noAssert)
        {
            return 0;
        }
        ...
        public static int ByteLength(string data, Encoding encoding)
        {
            return 0;
        }
        ...
        public static Buffer Concat(Buffer[] buffers, int totalLength)
        {
            return null;
        }
    }
