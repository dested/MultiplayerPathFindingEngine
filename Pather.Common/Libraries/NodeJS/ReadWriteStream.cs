...
namespace Pather.Common.Libraries.NodeJS
{
    ...
    public class ReadWriteStream : EventEmitter
    {
        ...
        // Hacky stuff
        [ScriptSkip]
        public static implicit operator ReadableStream(ReadWriteStream s)
        {
            return null;
        }

        [ScriptSkip]
        public static implicit operator WritableStream(ReadWriteStream s)
        {
            return null;
        }

        [ScriptSkip]
        public static explicit operator ReadWriteStream(ReadableStream s)
        {
            return null;
        }

        [ScriptSkip]
        public static explicit operator ReadWriteStream(WritableStream s)
        {
            return null;
        }
